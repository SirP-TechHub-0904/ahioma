...
class ReviewsList {
  ...
  ReviewsList() {
    this._reviewsList = [
      new Review(
          new User.basic('Maria R. Garza', 'img/user0.jpg', 'email', UserState.available),
          ...
          3.2),
      new Review(
          new User.basic('George T. Larkin', 'img/user1.jpg','email', UserState.available),
          'There are a few foods that predate colonization, and the European colonization of the Americas brought about the introduction of a large number of new ingredients',
          3.2),
      new Review(
          new User.basic('Edward E. Linn', 'img/user3.jpg','email', UserState.available),
          'There are a few foods that predate colonization, and the European colonization of the Americas brought about the introduction of a large number of new ingredients',
          3.2),
      new Review(
          new User.basic('George T. Larkin', 'img/user0.jpg','email', UserState.available),
          'There are a few foods that predate colonization, and the European colonization of the Americas brought about the introduction of a large number of new ingredients',
          3.2),
      new Review(new User.basic('Laurie Z. Bergeron', 'img/user1.jpg','email', UserState.available),

import 'package:ahioma/src/models/chat.dart';
...
class ConversationsList {
  ...
  ConversationsList() {
    this._conversations = [
      new Conversation(
          new User.basic('Kelly R. Hart', 'img/user2.jpg', 'email', UserState.available),
          [
            new Chat('Supports overlappi', '63min ago',
                new User.basic('Kelly R. Hart', 'img/user2.jpg', 'email', UserState.available)),
            new Chat('Accepts one sliver as content.', '15min ago', _currentUser),
            new Chat(
                'Header can ov', '16min ago', new User.basic('Kelly R. Hart', 'img/user2.jpg', 'email', UserState.available))
          ],
          false),
      new Conversation(
          new User.basic('Carol R. Hansen', 'img/user0.jpg', 'email', UserState.busy),
          [
            new Chat('Flutter project, add the following dependency ', '32min ago',
                new User.basic('Carol R. Hansen', 'img/user1.jpg', 'email', UserState.available)),
            ...
            new Chat('Notifies when the header scrolls outside the viewport. ', '12min ago',
                new User.basic('Carol R. Hansen', 'img/user1.jpg', 'user', UserState.available))
          ],
          true),
      new Conversation(
          new User.basic('Douglas M. Kirkpatrick', 'img/user2.jpg', 'email', UserState.away),
          [
            new Chat('Accepts one sliver as content. ', '1day ago',
                new User.basic('Douglas M. Kirkpatrick', 'img/user1.jpg', 'email', UserState.available)),
          ...
          true),
      new Conversation(
          new User.basic('John R. Whipple', 'img/user3.jpg', 'email', UserState.available),
          [
            new Chat('Can scroll in any direction. ', '63min ago',
                new User.basic('John R. Whipple', 'img/user1.jpg','email', UserState.available)),
          ...
          true),
      new Conversation(
          new User.basic('Jordan P. Jeffries', 'img/user0.jpg','email', UserState.away),
          [
            new Chat('For help getting started with Flutter ', '31min ago',
                new User.basic('Jordan P. Jeffries', 'img/user1.jpg', 'email', UserState.available)),
          ...
          false),
      new Conversation(
          new User.basic('Michele J. Dunn', 'img/user0.jpg', 'email', UserState.available),
          [
            new Chat('Accepts one sliver as content.', '45min ago',
                new User.basic('Michele J. Dunn', 'img/user1.jpg', 'email', UserState.available)),
          ...
          false),
      new Conversation(
          new User.basic('Regina R. Risner', 'img/user1.jpg', 'email', UserState.away),
          [
            new Chat('Can scroll in any direction.  ', '33min ago',
                new User.basic('Regina R. Risner', 'img/user1.jpg', 'email', UserState.available)),
            new Chat('Supports overlapping (AppBars for example). ', '33min ago', _currentUser),
          ...
          true),
      new Conversation(
          new User.basic('Patrick B. Scott', 'img/user0.jpg', 'email', UserState.busy),
          [
            new Chat('Supports overlapping AppBars for example. ', '33min ago',
                new User.basic('Patrick B. Scott', 'img/user1.jpg', 'email', UserState.available)),

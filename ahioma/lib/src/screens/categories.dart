...
class _CategoriesWidgetState extends State<CategoriesWidget> with AutomaticKeepAliveClientMixin {
  CategoriesList _categoriesList = new CategoriesList();
  SubCategoriesList _subCategoriesList = new SubCategoriesList();
  bool loading;
  Future getCategory()async{
    await  _categoriesList.getCathegoryList();
    setState(() {
      loading = false;
    });
  }
@override
  ...
  Widget build(BuildContext context) {
    if (_categoriesList.lisst.isEmpty){
      return Scaffold(
        // drawer: DrawerWidget(),
        // appBar: AppBar(
      ...
      body: SingleChildScrollView(
        ...
        child: Wrap(
          ...
          children: <Widget>[
            ...
            Wrap(
              runSpacing: 30,
              children: List.generate(_categoriesList.lisst.length, (index) {
                Category category = _categoriesList.lisst.elementAt(index);
        ...
        Expanded(
          child: Container(
            ...
            child: Wrap(
              ...
              spacing: 10,
              runSpacing: 5,
              children: List.generate(category.subCath.length, (index) {
                SubCategory subCategory = category.subCath.elementAt(index);
                SubCategoriesList subCath =SubCategoriesList();
                subCath.subCath=category.subCath;
                return Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      Navigator.of(context)
                          .pushNamed('/Category', arguments: RouteArgument(id: index, argumentsList: [category,subCath]));
                    },

...
class ShopGridWidget extends StatelessWidget {
  const ShopGridWidget({
    Key key,
    @required ShopsList brandsList,
  })  : _brandsList = brandsList,
        super(key: key);

  final ShopsList _brandsList;
  ...
  Widget build(BuildContext context) {
    return
      ...
      itemCount: _brandsList.lisst.length,
      itemBuilder: (BuildContext context, int index) {
        Shop brand = _brandsList.lisst.elementAt(index);
        return InkWell(
          onTap: () {
            Navigator.of(context)
                .pushNamed('/Shop', arguments: new RouteArgument(id: brand.id, argumentsList: [brand]));
          },
          child: Stack(

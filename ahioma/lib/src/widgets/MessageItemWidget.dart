...
import 'package:ahioma/src/models/conversation.dart' as model;
  ...
  Widget build(BuildContext context) {
    return Dismissible(
      ...
      onDismissed: (direction) {
        ...
        Scaffold.of(context)
            .showSnackBar(SnackBar(content: Text("The conversation with ${widget.message.user.firstName} is dismissed")));
      },
      child: InkWell(
        onTap: () {
            ...
            children: <Widget>[
              ...
              Flexible(
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      this.widget.message.user.firstName,

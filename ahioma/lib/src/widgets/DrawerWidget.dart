              ...
              builder: (BuildContext context, AsyncSnapshot<User> snapshot) {
                ...
                return GestureDetector(
                  onTap: () {
                   ...
                   else{ widget.control.jumpToPage(1);
...
//              borderRadius: BorderRadius.only(bottomLeft: Radius.circular(35)),
          ...
          ListTile(
            onTap: () {
              if(id=='guest'){
                Navigator.popAndPushNamed(context, '/SignUp',
                    arguments: (context) {Navigator.of(context).pushNamed('/Orders');});
              }
              else Navigator.of(context).pushNamed('/Orders', arguments: 0);
            },
            leading: Icon(
              UiIcons.inbox,
              color: Theme

...
class MarketGridWidget extends StatefulWidget {
  const MarketGridWidget({
    Key key,
    @required HomeMarket brandsList,
  })  : _marketsList = brandsList,
        super(key: key);

  final HomeMarket _marketsList;
...
class _MarketGridWidgetState extends State<MarketGridWidget> {
  ...
  Widget build(BuildContext context) {
     return StaggeredGridView.countBuilder(
      ...
      itemCount: widget._marketsList.lisst.length,
      itemBuilder: (BuildContext context, int index) {
        Market market = widget._marketsList.lisst.elementAt(index);
        return InkWell(
          onTap: () {
